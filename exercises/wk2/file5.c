...
/*
Changelog
1.tons of syntax errors
2.some logic errors in if statement
3.made the checker for 0 or 1 an or operator rather than an and operator
4.fixed it so there was the output specified by the assignment string
